  ...
  return (
    <SidebarProvider>
      <SidebarWrapper>
        <div
          className={cn(
            'lg:z-[999] lg:w-screen shrink-0 lg:fixed lg:top-0 lg:left-0 lg:px-4 lg:bg-gradient-to-l lg:from-[#141317] lg:to-[#121216] lg:h-[100px] lg:border-b lg:border-white/5 lg:flex lg:items-center lg:pb-0',
