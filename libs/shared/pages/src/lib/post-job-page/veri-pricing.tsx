  ...
  <div className="mx-auto max-w-7xl px-6 lg:px-8">
    <div className="mx-auto max-w-4xl text-center">
      <h2 className="text-base font-semibold leading-7 text-indigo-400 pb-4">
        Unlock Premium Features Beyond the Free Tier
      </h2>
      ...
      {tiers.map((tier, tierIdx) => (
        ...
        >
          <div>
            ...
            <p className="mt-4 leading-6 text-gray-600">{tier.description}</p>
            ...
            <ul className="mt-8 space-y-3 leading-6 text-gray-600">
