...
const SearchCategorySection = () => (
  <section className="relative mx-auto lg:max-w-6xl">
      <div className='my-10'>
        <svg className='w-4/5 md:h-[153px] mx-auto' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 630 159">
      ...
      <div>
        <h3 className={`${lato.className} text-white font-black text-5xl pb-3 md:text-6xl md:pb-6 text-center`}>Search Crypto Jobs by <span className='text-secondary'>Category</span></h3>
        <div className='flex flex-wrap items-center justify-center pb-6'>
          <div className='text-sm text-white border border-gray rounded-lg px-2.5 py-1.5 mr-2 mb-2'>Accounting</div>
          <div className='text-sm text-white border border-gray rounded-lg px-2.5 py-1.5 mr-2 mb-2'>Accounting</div>
          <div className='text-sm text-white border border-gray rounded-lg px-2.5 py-1.5 mr-2 mb-2'>Accounting</div>
          <div className='text-sm text-white border border-gray rounded-lg px-2.5 py-1.5 mr-2 mb-2'>Accounting</div>
          <div className='text-sm text-white border border-gray rounded-lg px-2.5 py-1.5 mr-2 mb-2'>Accounting</div>
