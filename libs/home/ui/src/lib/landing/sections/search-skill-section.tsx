...
const SearchSkillSection = () => (
  <section className="relative mx-auto lg:max-w-6xl">
    ...
    <div>
      <h3 className={`${lato.className} text-white !leading-tight font-black text-5xl md:text-6xl text-center pb-6`}>Search Crypto Jobs by <span className='text-secondary'>Skill</span></h3>
