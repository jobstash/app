...
const SetsUsSection = () => (
  <section className="relative mx-auto lg:max-w-6xl">
    <svg className='h-[94px] my-10 mx-auto' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 12 101">
          ...
          >
            <div className='bg-white bg-opacity-5 p-5 rounded-3xl'>
              ...
              <div className='mt-6 aspect-w-16 aspect-h-6'>
                <img className='object-center object-cover' src='https://placehold.co/600x400/EEE/31343C' />
              </div>
            </div>
          </div>
          <div
