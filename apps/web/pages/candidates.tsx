              ...
              <div className="w-full px-2 mb-4 md:w-1/3">
                <div className="p-5 bg-white bg-opacity-5 rounded-3xl">
                  ...
                  <p className="text-left text-md text-white/75 pb-">
                    ...
                    industries. High performance teams are built on trust, and
                    we embrace this natively by surfacing applicants that are
                    currently working in the industry or that are crypto
                    adjacent, so that when you interview with JobStash, you know
                    the person you&#39;re talking to is the real deal. Great
                    talent has the best chance of being hired using JobStash.
                  </p>
                  {/* <div className="mt-6 aspect-w-16 aspect-h-6">
              <Image
                fill
              ...
              <div className="w-full px-2 mb-4 md:w-2/3">
                <div className="p-5 bg-white bg-opacity-5 rounded-3xl">
                  ...
                  <p className="text-left text-md text-white/75 pb-">
                    ...
                    We actively encourage people to introduce themselves via
                    their trusted personal network, as we believe that crypto
                    teams are built on reputation and trust.
                  </p>
              ...
              <div className="w-full px-2 md:w-1/3">
                <div className="p-5 bg-white bg-opacity-5 rounded-3xl">
                  ...
                  <p className="text-left text-md text-white/75 pb-">
                    ...
                    pipelines that consume literal years of compute time to
                    import all of crypto GitHub, just to be able to detect if a
                    user is actually part of an organization, as he may claim.
                    See, in crypto you can&#39;t trust anybody. We take the same
                    approach. We verify every single bit of data, and strive for
                    accuracy and completeness. We don&#39;t simply operate as a
                    job board. We are an intelligence hub for people operations
                    in crypto, and base this on
                  </p>
                  {/* <div className="mt-6 aspect-w-16 aspect-h-6">
              <Image
                fill
