          ...
          <Stack spacing={15}>
            ...
            <Stack spacing={10}>
              ...
              <Text c="dimmed" size="md">
                ...
                design, and execution of all future product experiences. We work
                in React, TypeScript, Elixir, Elm, Solidity, Rust, and are
                regularly pulling in functional programming languages and tools,
                forever learning and optimizing everything we make in the name
                of correct coding.
              </Text>
            </Stack>
            ...
            <Stack spacing={10}>
              ...
              <Text c="dimmed" size="md">
                ...
                individuals who are dedicated to building the future of finance.
                We are a diverse group of people from all walks of life, with
                different backgrounds and experiences. We are united by our
                shared mission to create a more open, accessible, and fair
                financial system.
              </Text>
            </Stack>
            ...
            <Stack spacing={10}>
              ...
              <Text c="dimmed" size="md">
                Once you&#39;ve applied, please be patient :) it may take us up
                to 2-3 weeks to get back to you! Don&#39;t meet every single
                requirement? Studies have shown that women and people of color
                are less likely to apply to jobs unless they meet every single
                qualification. We are dedicated to building a diverse, inclusive
                and authentic workplace, so if you&#39;re excited about this
